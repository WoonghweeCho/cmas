...
var oniFrameload = function () {
	...
	<!-- JavaScript Logic 처리 -->
	<ut:script src="${contextPath}/info/site/siteLoc_s.js"></ut:script>
...
<body onload="oniFrameload()">
		...
		<div id="box">
			...
			<table style="margin:0px;padding:0px">
				<tr>
					<td><div id="siteLocMap" style="width:200px;height:150px"></div></td>
					<td><!--목록-->
			...
			<div class="box" style="float:left">
				...
				<!--리스트-->
				<div class="list_st2" style="min-height:130px;">
					<table id="siteLocList" style="width: 180px;"></table>
