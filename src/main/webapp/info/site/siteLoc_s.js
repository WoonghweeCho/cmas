...
//	alert(ds_SiteLocList.size());
    ...
    for(var s=0; s< ds_SiteLocList.size(); s++){
    	locations[s] = ["<div style='font-size:9px'>"+ds_SiteLocList.get(s, "siteNm") + "<br>현장소장 : " + ds_SiteLocList.get(s, "siteSvNm") + "<br>공사기간 : " + ds_SiteLocList.get(s, "conDate") + "<br>공사개요 : " + ds_SiteLocList.get(s, "conOutline") + "<br>주소 : " + ds_SiteLocList.get(s, "addr")+"</div>", ds_SiteLocList.get(s, "latitude"), ds_SiteLocList.get(s, "longitude"),ds_SiteLocList.get(s, "sortNo")];
    }
