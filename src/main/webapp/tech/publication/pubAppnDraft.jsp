...
<!-- JavaScript Logic 처리  -->
<ut:script src="${contextPath}/tech/publication/pubAppnDraft.js"></ut:script>
	...
	<div id="popup_wrap">
		...
		<div id="content">
			...
			<div id="viewTitle" class="form_title" align="center">
				<h6>
					<span id="signFormTitle">사내간행물 열람신청</span>
				</h6>
			</div>
			<!-- //양식명칭 -->
					...
					<form>
						<table width="100%" border="0" cellspacing="3" cellpadding="0">
							<tr>
								...
								<td class="inpt" style="width:90%">&nbsp;<span id="issueRegNo"></span>
								<span id="cls" style='display:none'></span><span id="regNo" style='display:none'></span>
								</td>
							</tr>
