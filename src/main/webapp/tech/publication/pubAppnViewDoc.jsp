...
<jsp:include page="/common/jsp/comm/include/clientLib.jsp">
	<jsp:param value="사내간행물 열람 신청" name="title" />
...
<!-- JavaScript Logic 처리  -->
<ut:script src="${contextPath}/tech/publication/pubAppnViewDoc.js"></ut:script>
...
<body id="popup_body">
	...
	<div id="popup_wrap">
		...
		<div id="content">
			...
			<!--BTN-->
			<div class="btn-area">
				<a class="btn s1" id="btnComplete" style="display:none"><span>열람승인</span></a>
			...
			<div id="viewTitle" class="form_title" align="center">
				<h6>
					<span id="signFormTitle">사내간행물 열람 신청</span>
				</h6>
			</div>
			<!-- //양식명칭 -->
					...
					<form>
						<table width="100%" border="0" cellspacing="3" cellpadding="0">
							<tr>
								...
								<td class="inpt" style="widht:40%"><span id="issueRegNo"></span></td>
								<td class="tit" style="width:10%">등록번호</td>
								<td class="inpt" style="widht:40%"><span id="regNo"></span></td>
							</tr>
							<tr>
								<td class="tit" style="width:10%">문서번호</td>
								<td class="inpt" style="widht:90%" colspan=3><span id="docNo"></span></td>
							</tr>
 						</table>
					</form>
				</div>
				...
				<div class="list_st1">
					<form>
						...
						<tr>
							...
							<td class="inpt" style="width:40%"><span id="appnDd"></span></td>
