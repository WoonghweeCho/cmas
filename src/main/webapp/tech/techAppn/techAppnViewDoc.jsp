...
<jsp:include page="/common/jsp/comm/include/clientLib.jsp">
	<jsp:param value="도서/DVD 대여 신청" name="title" />
...
<!-- JavaScript Logic 처리  -->
<ut:script src="${contextPath}/tech/techAppn/techAppnViewDoc.js"></ut:script>
...
<body id="popup_body">
	...
	<div id="popup_wrap">
		...
		<div id="content">
			...
			<!--BTN-->
			<div class="btn-area">
				<a class="btn s2" id="btnRent" style="display:none"><span>대출</span></a>
				<a class="btn s2" id="btnReturn" style="display:none"><span>반납</span></a>
				<a class="btn s2" id="btnDelete" style="display:none"><span>삭제</span></a>
				<a class="btn s5" id="btnBackCancle" style="display:none"><span>취소</span></a>
				...
				<form id='techDataDtlForm'>
					<table width='100%' border='0' cellspacing='3' cellpadding='0'>
						...
						<tr>
							...
							<td class='inpt'style="width:40%"><span id="rentDd"></span></td>
							<td class='tit' style="width:10%">반납일</td>
							<td class='inpt' style="width:40%"><span id="rtrnDd"></span>&nbsp;<span id="betDay"></span></td>
						</tr>
						</table>
					</form>
				</div>
