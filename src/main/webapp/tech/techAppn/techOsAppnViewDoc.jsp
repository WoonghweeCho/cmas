...
<jsp:include page="/common/jsp/comm/include/clientLib.jsp">
	<jsp:param value="해외산업규격 신청" name="title" />
...
<!-- JavaScript Logic 처리  -->
<ut:script src="${contextPath}/tech/techAppn/techOsAppnViewDoc.js"></ut:script>
...
<body id="popup_body">
	...
	<div id="popup_wrap">
		...
		<div id="content">
			...
			<!--BTN-->
			<div class="btn-area">
				<a class="btn s2" id="btnReturn" style="display:none"><span>처리완료</span></a>
			...
			<div id="viewTitle" class="form_title" align="center">
				<h6>
					<span id="signFormTitle">해외산업규격 신청</span>
				</h6>
			</div>
			<!-- //양식명칭 -->
