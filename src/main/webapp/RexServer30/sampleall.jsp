...
function fnOpen()
{
	...
	//oReport.rptname = "samples/customers";
	oReport.rptname = "acpf/ACPF_0002";
	...
	oReport.connectname= "oracleACPF";

	// 옵션 - 레포트 파라메터
	oReport.param("businnm").value = "통합테스트]PJ수지관리_1";
	oReport.param("ver").value = "1";
	oReport.param("prctr").value = "KVOF6";
