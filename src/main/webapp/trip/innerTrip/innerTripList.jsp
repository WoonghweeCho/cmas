...
<%-- JavaScript Logic 처리 --%>
<ut:script src="${contextPath}/trip/innerTrip/innerTripList.js"></ut:script>
...
<body>
	...
	<div id="container">
		...
		<div id="map_bar">
			...
			<div class="map">
				<span>국내출장</span> &nbsp;>&nbsp; <strong>국내출장 정산서</strong>
			</div>
		</div>
		<!--//top_bar-->
		...
		<div id="contents">
			...
			<!-- Button -->
			<div class="btn-area">
				<a class="btn s1" id="innerTripError" style="display:none"><span>에러케이스 확인</span></a>
				<a class="btn s1" id="innerTripSearch"><span>조회</span></a>
				<a class="btn s5" id="innerTripDraft"><span>작성</span></a>
			</div>
					...
					<!-- 검색 조건 시작 -->
						<table id="table_sign_search" width="100%" border="0"
							...
							<tr>
								...
								<td class="tit">출장자</td>
								<td class="inpt">
									<span id="tripUserInput" style="display: inline-block; width: 150px; height: 22px"></span>
								</td>
			...
			<!--임시저장함 목록-->
			<div class="box">
				<h3><span id="innerTripListCnt"></span> <span>목록</span></h3><span class="cont" ><span id="listCnt"></span></span>
