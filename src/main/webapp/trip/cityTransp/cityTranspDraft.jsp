...
<!-- JavaScript Logic 처리 -->
<ut:script src="${contextPath}/trip/cityTransp/cityTranspDraft.js"></ut:script>
 ...
 -->
	...
	<div id="container">
		...
		<div id="contents">
			...
			<div class="btn-area">
				<a class="btn s1" id="cityTranspDelete" style="display:none"><span>삭제</span></a>
				<a class="btn s1" id="cityTranspSign"><span>결재선 지정</span></a>
				<a class="btn s1" id="cityTranspSave"><span>저장</span></a>
				<a class="btn s1" id="cityTranspDraft"><span>상신</span></a>
			</div>
			...
			<div class="list_st1">
				...
				<table id="docInfo">
						<tr>
							...
							<td class="inpt" style="width:90%" colspan="7" id="docNo"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%">작성자</td>
							<td class="inpt" style="width:90%" colspan="7" id="writer"></td>
						</tr>
						<!-- <tr>
							<td class="tit" style="width:10%">전표번호</td>
							<td class="inpt" style="width:10%"></td>
							<td class="tit" style="width:10%">Ref No</td>
							<td class="inpt" style="width:10%"></td>
							<td class="tit" style="width:10%">기표일자</td>
							<td class="inpt" style="width:20%"></td>
				...
				<table id="docInfoDetail">
						<tr>
							...
							<td class="inpt" style="width:40%">
								<span id="bdgtType"></span> (<input name="docType" type="radio" value="H">본사 <input name="docType" type="radio" value="G">지역)</span>
								<a href="javascript:;" class="button-light" id="cityTranspNumChange">예산번호 선택</a>
							</td>
						...
						<tr>
							...
							<td class="inpt" style="width:90%" colspan="3" id="bdgtTeam"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%">소속팀</td>
							<td class="inpt" style="width:90%" colspan="3">
								<span id="drafterOrgNm"></span> <a href="javascript:;" class="button-light" id="orgChgBtn">소속팀 변경</a>
							</td>
						</tr>
						<tr>
							<td class="tit" style="width:10%">최종수정자</td>
							<td class="inpt" style="width:90%" colspan="3" id="drafter">
				...
				<table id="transpInfo" >
						<tr>
							...
							<td class="tit" style="width:3%; text-align:center"></td>
						</tr>
				</table>
				<div>
					<span class="pull-right">
						<a href="javascript:;" class="button-light" id="addBtn">추가</a>
						<a href="javascript:;" class="button-light" id="delBtn">삭제</a>
					</span>
				</div>
				<table id="amountInfo" >
						<tr>
			...
			<div>
				...
				<span>
					...
					<font color="blue">
					 ...
					 ※ 본사경비 담당자 : 경영관리팀  이상민 차장 (02-2288-3101), 강해연 사원 (02-2288-4603) <br>
					</font>
					</b>
				</span>
				 </td>
