...
<!-- JavaScript Logic 처리 -->
<ut:script src="${contextPath}/trip/outerTrip/outerTripDraft.js"></ut:script>
...
<body id="popup_body">
 ...
 -->
		...
		<div id="contents">
			...
			<div class="btn-area">
				<a class="btn s1" id="outerTripSign"><span>결재선지정</span></a>
				<a class="btn s1" id="outerTripCheck" style="display:none"><span>예산체크</span></a>
				<a class="btn s1" id="outerTripDelete" style="display:none"><span>삭제</span></a>
				<a class="btn s1" id="outerTripSECNotConfirm" style="display:none"><span>반려</span></a>
				<a class="btn s1" id="outerTripSECConfirm" style="display:none"><span>검토완료</span></a>
				...
				<a class="btn s1" id="outerTripHRConfirm" style="display:none"><span>검토완료</span></a>
 				<a class="btn s1" id="outerTripMNGNotConfirm" style="display:none"><span>반려</span></a>
				<a class="btn s1" id="outerTripMNGConfirm" style="display:none"><span>검토완료</span></a>
				<a class="btn s1" id="outerTripSave"><span>저장</span></a>
				<a class="btn s1" id="outerTripDraft"><span>협조의뢰</span></a>
			</div>
			...
			<div class="list_st1">
				...
				<table id="docInfoDetail">
						<tr>
							<td class="tit" style="width:10%">출장자 (<span style="">*</span>)</td>
							<td class="inpt" style="width:90%">
								<span id="tripUser" style="display: inline-block; width: 150px; height: 22px"></span> <span id="tripUserDtl"></span>
								<table>
									<tr>
										<td class="tit" style="width:25%;">출장자 영문이름(티켓과 동일)</td>
										<td class="inpt" style="width:25%;"><input type="text" id="tripUserEnm" style="ime-mode:disabled;"></td>
										...
										<td class="inpt" style="width:20%;"><input type="text" id="tripUserAirAmount" value="0" style="width:90%;text-align:right">원</td>
									</tr>
								</table>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="inpt" style="width:90%"><input id="tPurp" type="text" style="width: 95%" maxlength="40"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="inpt" style="width:90%">
								<table>
										...
										<tr>
											<td class="inpt" style="width:50%; text-align:center"><input type="text" id="fPassp" style="text-align:center"></td>
											<td class="inpt" style="width:50%; text-align:center"><input type="text" id="tPassp" style="text-align:center"></td>
										</tr>
								</table>
							</td>
						</tr>
				...
				<div class="clear">&nbsp;</div>
				<h3><span>SAP 예산집행</span></h3> &nbsp; <a href="javascript:;" class="button-light" id="bdgtBtn">예산번호 선택</a>
				<table>
						<tr>
						...
						<tr>
							...
							<td class="inpt" style="width:90%" colspan="3">
								...
								<span id="VTCodeSpan" style="display:none;"> / 경비이체코드 : <input type="text" id="vTcode"></span>
							</td>
						</tr>
						<tr>
				...
				<table>
						...
						<tr>
							...
							<td class="inpt" style="width:30%;">$ <input type="text" id="loAirFare"> / \    <span id="loAirFareEx">0</span></td>
						...
						<tr>
							...
							<td class="inpt" style="width:30%;">$ <input type="text" id="loTranFare"> / \    <span id="loTranFareEx">0</span></td>
						...
						<tr>
							...
							<td class="inpt" style="width:30%;">$ <input type="text" id="visaFeeFare"> / \    <span id="visaFeeFareEx">0</span></td>
						...
						<tr>
							...
							<td class="inpt" style="width:30%;">$ <input type="text" id="ovCharFare"> / \    <span id="ovCharFareEx">0</span></td>
						...
						<tr>
							...
							<td class="inpt" style="width:30%;">$ <input type="text" id="vocLeeFare"> / \    <span id="vocLeeFareEx">0</span></td>
						...
						<tr>
							...
							<td class="inpt" style="width:30%;">$ <input type="text" id="hostFare"> / \    <span id="hostFareEx">0</span></td>
						...
						<tr>
							...
							<td class="inpt" style="width:30%;">$ <span id="etcTotalUSD">0</span> / \ <span id="etcTotalEx">0</span></td>
							<td class="inpt" style="width:60%; text-align:center"> (기타비용정산예정일 : <input type="text" id="etcPayDate" style="width:80px">)</td>
						</tr>
				</table>
				<div class="clear"></div>
				※ 기타경비 정산은 SAP 가불정산화면을 이용하여 별도 처리 하시기 바랍니다.<br>
				※ 기타경비는 법인카드 또는 현금만 정산가능<br>
				※ 예방접종비는 복리후생 항목에 금액 입력 및 집행세부내역에 예방접종 종류 기재
				<div class="clear"></div>
				<br>
				<h3><span>체재비</span></h3>
				<table>
						<tr>
							...
							<td class="inpt" style="width:90%;">
								<input name="innType" type="radio" value="H"> 현장숙소 <input name="innType" type="radio" value="G"> 외부숙소(호텔)
							</td>
						</tr>
						<tr id="inputAmtTr">
