...
<!-- JavaScript Logic 처리 -->
<ut:script src="${contextPath}/trip/outerTrip/outerTripAdjust.js"></ut:script>
...
<body id="popup_body">
 ...
 -->
		...
		<div id="contents">
			...
			<div class="btn-area">
 				<a class="btn s1" id="inputRet" style="display:none"><span>반납자 / 반납일 입력</span></a>
 				<a class="btn s1" id="retComp" style="display:none"><span>반납 완료</span></a>
 				<a class="btn s1" id="retCancel" style="display:none"><span>반납 취소</span></a>
 				<a class="btn s1" id="outerTripSign"><span>결재선지정</span></a>
 				<a class="btn s1" id="outerTripCheck" style="display:none"><span>예산체크</span></a>
 				<a class="btn s1" id="adjustDelete" style="display:none"><span>삭제</span></a>
 				<a class="btn s1" id="adjustBack" style="display:none"><span>임시저장B</span></a>
 				...
 				<a class="btn s1" id="outerTripMANNotConfirm" style="display:none"><span>반려</span></a>
 				<a class="btn s1" id="outerTripMANConfirm" style="display:none"><span>검토완료</span></a>
 				...
 				<a class="btn s1" id="adjustSave"><span>저장</span></a>
 				<a class="btn s1" id="adjustDraft"><span>협조의뢰</span></a>
			</div>
			...
			<div class="list_st1">
				...
				<table id="docInfo">
						...
						<tr>
							...
							<td class="inpt" style="width:90%" colspan="3">
								<select id="jsGubun">
								 ...
								 <b>※ 정산서는 체재비 과부족을 기준으로 지정</b> <a href="javascript:;" class="button-light" id="jsExm">예제보기</a>
							</td>
						</tr>
						<tr>
						...
						<tr id="signAssistor">
							...
							<td class="inpt" colspan="3">
								<span id="signAssistorVal"></span>
								<div style="color:red">※ 위 담당자가 협의자로 자동지정됩니다. CRM DB(출장보고서) 협의자에 전달 후 협의결재 진행</div>
							</td>
						</tr>
						<!-- //IF 협의자 존재 -->
				</table>
				<table id="docInfoDetail">
						...
						<tr>
							...
							<td class="inpt" style="width:90%">
								<input type="text" id="tripNat" readonly="readonly">  <a href="javascript:;" class="button-light" id="selNat">국가선택</a>
							</td>
						</tr>
						<tr>
				...
				<table>
						<tr>
							<td class="tit">숙박시설</td>
							<td class="inpt"><input type="text" size=5 id="s1">일</td>
							<td class="tit">해외현장</td>
							<td class="inpt"><input type="text" size=5 id="s2">일</td>
							<td class="tit">법인/지사</td>
							<td class="inpt"><input type="text" size=5 id="s3">일</td>
						</tr>
						<tr>
				...
				<div class="clear"></div>
				<div style="color:red">※ 기타경비 실사용 금액 입력시 법인카드 원화 금액과 동일하게 입력 (USD환산=원화금액/지급당시 환율, 정산서 금액과 상이할 시 SAP 처리 불가)</div>
				<div style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;원화금액 확인 (바로넷 - 업무시스템 - 재무- 법인카드-미정산내역)</div>
				<div>&nbsp;</div>
				<div>※ 기타경비 정산은 SAP 가불정산화면을 이용하여 별도 처리 하시기 바랍니다.</div>
				<div>&nbsp;</div>
				<div style="color:blue">※해외출장 정산서 작성시 "휴일이동에 대한 대체휴무는 e-HR을 통해 신청하시기 바랍니다.(직책보임자 제외)"&nbsp;&nbsp;&nbsp;<a href="http://ehr.daewooenc.com/ssoLogin_ok_.jsp?Gw_Lang=KR&objId=BSM0000_ODM" target="_blank">▶ 바로가기 ◀</a> </div>
				...
				<table>
						...
						<tr>
							...
							<td class="inpt" style="text-align: center; width:88%;" colspan="7"><textarea id="assDtl" style="width: 95%; height: 50px;" readonly="readonly"></textarea></td>
						</tr>
						<tr id="ghrTr" style="display:none">
							<td class="tit" style="text-align: center; width:12%;">GHR <br> 협조팀 의견<br>
								<span id="draftGhrCommentPop" style="display:none"><a href="javascript:;" class="button-light" id="ghrBtn">신청서의견</a></span>
							</td>
