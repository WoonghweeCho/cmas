...
//		try {
//			var target = $(ele);
//			if ( target.children().length == 0 && ele.tagName != "OBJECT" && ele.tagName != "PARAM" ) {
//				if(target.length) target.attr('lang','kr');
//			}
//		} catch (e) {
//			console.log(e);
//		}
			...
			while (elemsLength--) {
				...
				if (langElem.attr('data-deftexttitle')) {
					if (langElem.attr('title')) {
						...
						var newText = typeof(this.lang[lang][defaultLangText]) != "unknown"? typeof(this.lang[lang][defaultLangText]) : currentText;
