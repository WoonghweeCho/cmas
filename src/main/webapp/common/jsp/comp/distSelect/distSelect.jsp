...
<ut:script src="${contextPath}/common/jsp/comp/distSelect/cityList.js"></ut:script>
<ut:script src="${contextPath}/common/jsp/comp/distSelect/distSelect.js"></ut:script>
				...
				<div class="content">
					...
					<table id="bdgtSearchForm" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="inpt">
								<span>출발지</span>
								<select id="startDist" style="width: 100px" ></select>
								<select id="startCity" style="width: 100px" ></select>
							</td>
						</tr>
						<tr>
							<td class="inpt">
								<span>도착지</span>
								<select id="endDist" style="width: 100px" ></select>
								<select id="endCity" style="width: 100px" ></select>
							</td>
						</tr>
					</table>
