...
<jsp:include page="/common/jsp/comm/include/clientLib.jsp">
	<jsp:param value="특별ID 기본정보변경 신청" name="title" />
...
<!-- JavaScript Logic 처리  -->
<ut:script src="${contextPath}/id/idAppn/idAppnEditDraft.js"></ut:script>
	...
	<div id="popup_wrap">
		...
		<div id="content">
			...
			<div id="viewTitle" class="form_title" align="center">
				<h6>
					<span id="signFormTitle">특별ID 기본정보변경 신청</span>
				</h6>
			</div>
			<!-- //양식명칭 -->
					...
					<form>
						<table width="100%" border="0" cellspacing="3" cellpadding="0">
							...
							<tr>
								...
								※ 연장신청중인 아이디의 경우, 결재가 완료 된 후 변경 신청 해주시기 바랍니다.
								</span></td>
							</tr>
						</table>
					</form>
...
<!-- 						<tr>
 ...
 -->
						...
						<tr>
							...
							<td class='inpt'><input type="text"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="mphoneNo" id="mphoneNo" style="width: 98%" class="int_s1"></td>
						 	<td class='inpt'></td>
						</tr>
