			...
			<div class="box">
				...
				<form id='idAppnDtlForm'>
					...
					<form id='idAppnSysMobile'>
					 ...
					 <!-- ////CWH 202201025  특별ID 운영 배포 건으로 개발에만 적용중인 똑바로 안전 관련 내용 주석처리 -->
<!-- 					 <form id='idAppnSysSafety'>
						...
						<col width='50%' />
						<tr>
							<td class='tit'>* 똑바로<br>(안전)</td>
						 	<td class='inpt' id='safety' name='safety'></td>
						 	<td class='inpt'>※ 사용 선택 시, 협의자로 똑바로 담당자 추가됨<br>
						 					※ (웹)똑바로 접근 URL : http://iworks.daewooenc.com/ssfs<br>
						 					※ (모바일) 설치 URL : http://dstore.daewooenc.com/main_open.html<br>
						 					※ 담당자: 안전혁신팀 김정규 과장 (02-2288-2182)
						 	</td>
						</tr>
					</table>
					</form> -->
					<!-- ////CWH 20220811 특별ID 운영 배포 건으로 개발에만 적용중인 똑바로 안전 관련 내용 주석처리 -->
