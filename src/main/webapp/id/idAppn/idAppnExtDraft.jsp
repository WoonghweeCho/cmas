...
<jsp:include page="/common/jsp/comm/include/clientLib.jsp">
	<jsp:param value="특별ID 연장신청" name="title" />
...
<!-- JavaScript Logic 처리  -->
<ut:script src="${contextPath}/id/idAppn/idAppnExtDraft.js"></ut:script>
	...
	<div id="popup_wrap">
		...
		<div id="content">
			...
			<div id="viewTitle" class="form_title" align="center">
				<h6>
					<span id="signFormTitle">특별ID 연장 신청</span>
				</h6>
			</div>
			<!-- //양식명칭 -->
			...
			<div class="box">
				...
				<form id='idAppnDtlForm'>
					<table width='100%' border='0' cellspacing='3' cellpadding='0'>
						...
						<tr>
							<td class='tit'>이메일</td>
							<td class='inpt'><input type="text" name="compMail" id="compMail" style="width: 98%" class="int_s1" readonly></td>
						 	<td class='inpt'><span class="s4" style="color:red;">
								※ 메일 사용이 필요하시면 daewooenc 메일로 신규 신청하시기 바랍니다. <br>
								</span>
						 	</td>
						</tr>
