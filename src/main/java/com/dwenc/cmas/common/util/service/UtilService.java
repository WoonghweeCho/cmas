package com.dwenc.cmas.common.util.service;
...
public class UtilService {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getEaSignId(Map<String, Object> input) {
		return dao.queryForMapList("/ea/eaz/d99/common/getEaSignId", input);
	}
	...
	public List<Map<String, Object>> retrieveUserListPopup(Map<String, Object> input) {
		return dao.queryForMapList("select/dwe/common/util/retrieveUserListPopup", input);
	}
	...
	public List<Map<String, Object>> retrieveOrgListPopup(Map<String, Object> input) {
		return dao.queryForMapList("select/dwe/common/util/retrieveOrgListPopup", input);
	}
	...
	public List<Map<String, Object>> retrieveMenuListPopup(Map<String, Object> input) {
		return dao.queryForMapList("select/dwe/common/util/retrieveMenuListPopup", input);
	}
	...
	public List<Map<String, Object>> retrieveSiteListPopup(Map<String, Object> input) {
		return dao.queryForMapList("select/dwe/common/util/retrieveSiteListPopup", input);
	}
	...
	public List<Map<String, Object>> retrieveDynamicQuery(Map<String, Object> input) {
		return dao.queryForMapList("select/dwe/common/util/retrieveDynamicQuery", input);
	}
	...
	public String retrieveDBSequence(String strSeqNm) {
		...
		String instcCd = UserInfo.getInstanceId();
		input.put("seqNm", strSeqNm);
		input.put("instcCd", instcCd);
