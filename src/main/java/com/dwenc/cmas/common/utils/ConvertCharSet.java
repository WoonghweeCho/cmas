...
public class ConvertCharSet {
     ...
     */
    	public static void main(String[] args) {
    		...
    		String sArg0 = "euc-kr";
    		String sArg1 = "UTF-8";
            String sArg2 = "C:/docfbaro-dev/workspace/DWE_OZ/com.dwenc.cmas-core_src";
//            String sArg2 = "C:/docfbaro-dev/workspace/DEV_RUI/com.dwenc.cmas-framework_src";
//            String sArg2 = "C:/docfbaro-dev/workspace/DEV_RUI/com.dwenc.cmas-webservice_src";
    		if (args[0] != null) {
    			sArg0 = args[0];
    		}
    		if (args[1] != null) {
    ...
    //		String includes = "dtd";
    		...
    		// iso_8859-1 EUC_KR UTF-8 C:\AADEV_HSNI\workspace\HSNI_ERP_DWE\src
