...
<ut:script src="${contextPath}/trip/outerTrip/visaInfoList.js"></ut:script>
 ...
 <!--right-->
	...
	<div id="popup_wrap">
		...
		<div id="contents">
			...
			<!-- Button -->
			<div class="btn-area">
				<a class="btn s1" id="visaInfoClose"><span>닫기</span></a>
			</div>
				...
				<div class="content">
						<table id="table_sign_search" width="100%" border="0"
							...
							<tr>
								<td class="tit">국가명</td>
								<td class="inpt">
									<input name="natNmInput" id="natNmInput" type="text" style="width: 130px;" class="int_s1" />
								</td>
								<!-- <td class="tit">국내 비자 진행여부</td>
								<td class="inpt">
									<select name="visaYn" id="visaYn" style="width: 126px" class="sel_st1">
										<option value="Y">Y</option>
										<option value="N">N</option>
									</select>
								</td>
								<td class="tit">위험여부</td>
								<td class="inpt">
									<select name="warnConf" id="warnConf" style="width: 126px" class="sel_st1">
										<option value="Y">Y</option>
										<option value="N">N</option>
									</select>
								</td> -->
