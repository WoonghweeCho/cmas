...
//			gf_AlertMsg("[dwenc.com] 메일은  연장 불가합니다. \n\n 업무상 회사 메일 사용이 필요하시면  \n\n 특별ID[daewooenc 메일 사용] 신규 신청하시기 바랍니다." +
//						"\n\n 문의 : 디지털개발팀 이진혁대리(02-2288-3464) ");
//			return false;
//		} //// dwenc.com 도메인 메일 연장 중지 (일단 보류)
		...
		if(ds_IdAppnDtlList.get(i, "memo" ) == ""){
			ds_IdAppnDtlList.setPosition(i, true);
			gf_AlertMsg("변경사유 입력은 필수입니다.");
			return false;
		}
