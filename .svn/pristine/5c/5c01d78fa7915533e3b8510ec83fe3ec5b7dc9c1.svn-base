...
<%-- JavaScript Logic 처리 --%>
<ut:script src="${contextPath}/trip/outerTrip/outerTripViewDoc.js"></ut:script>
...
<body id="popup_body">
	<!--
	Class Name 	: outerTripViewDoc.jsp
	Description : 해외출장신청 열람
 -->
		<div id="contents">

			<div class="btn-area">
				<!-- <a class="btn s1" id="outerTripAdjust" style="display:none"><span>정산서 작성</span></a>  -->
				...
				<a class="btn s1" id="outerTripReDraft" style="display:none"><span>재작성</span></a>
			...
			<div class="list_st1">
				...
				<table id="docInfoDetail">
							...
							<td class="inpt" style="width:90%">
								...
								<table>
									<tr>
										...
										<td class="inpt" style="width:25%;"><input type="text" id="tripUserEnm" style="border:0" readonly="readonly"></td>
										<td class="tit" style="width:10%;">좌석등급</td>
										<td class="inpt" style="width:10%;">
												<select name="tripUserGrade" style="border:0" disabled="disabled">
										...
										<td class="inpt" style="width:20%;"><input type="text" id="tripUserAirAmount" style="width:90%;border:0" readonly="readonly">원</td>
									</tr>
								</table>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="inpt" style="width:90%"><input id="tPurp" type="text" style="width:95%;border:0" readonly="readonly"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%">요청 사항</td>
							<td class="inpt" style="width:90%"><textarea id="tReq" style="width: 95%; height: 50px;border:0" readonly="readonly"></textarea></td>
						</tr>
				</table>
				<div class="clear"></div>
				<br>
				...
				<table>
						...
						<tr>
							...
							<td class="inpt" style="width:90%" colspan="2">
								<textarea id="pecul" style="width:95%;border:0" readonly="readonly"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="inpt" style="width:30%; text-align:center">$ <input type="text" id="loAirFare" style="border:0" readonly="readonly"> / \    <span id="loAirFareEx">0</span></td>
							<td class="inpt" style="width:60%; text-align:center"><input type="text" id="loAirFareDtl" style="width:90%; border:0" readonly="readonly"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%; text-align:center">현지교통비</td>
							<td class="inpt" style="width:30%; text-align:center">$ <input type="text" id="loTranFare" style="border:0" readonly="readonly"> / \    <span id="loTranFareEx">0</span></td>
							<td class="inpt" style="width:60%; text-align:center"><input type="text" id="loTranFareDtl" style="width:90%; border:0" readonly="readonly"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%; text-align:center">VISA FEE</td>
							<td class="inpt" style="width:30%; text-align:center">$ <input type="text" id="visaFeeFare" style="border:0" readonly="readonly"> / \    <span id="visaFeeFareEx">0</span></td>
							<td class="inpt" style="width:60%; text-align:center"><input type="text" id="visaFeeFareDtl" style="width:90%; border:0" readonly="readonly"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%; text-align:center">Over Charge</td>
							<td class="inpt" style="width:30%; text-align:center">$ <input type="text" id="ovCharFare" style="border:0" readonly="readonly"> / \    <span id="ovCharFareEx">0</span></td>
							<td class="inpt" style="width:60%; text-align:center"><input type="text" id="ovCharFareDtl" style="width:90%; border:0" readonly="readonly"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%; text-align:center">복리후생</td>
							<td class="inpt" style="width:30%; text-align:center">$ <input type="text" id="vocLeeFare" style="border:0" readonly="readonly"> / \    <span id="vocLeeFareEx">0</span></td>
							<td class="inpt" style="width:60%; text-align:center"><input type="text" id="vocLeeFareDtl" style="width:90%; border:0" readonly="readonly"></td>
						</tr>
						<tr>
							<td class="tit" style="width:10%; text-align:center">접대비</td>
							<td class="inpt" style="width:30%; text-align:center">$ <input type="text" id="hostFare" style="border:0" readonly="readonly"> / \    <span id="hostFareEx">0</span></td>
							<td class="inpt" style="width:60%; text-align:center"><input type="text" id="hostFareDtl" style="width:90%; border:0" readonly="readonly"></td>
						</tr>
						<tr>
							...
							<td class="inpt" style="width:60%; text-align:center"> (기타비용정산예정일 : <input type="text" id="etcPayDate" style="width:80px; border:0" readonly="readonly">)</td>
						</tr>
				</table>
				<div class="clear"></div>
				※ 기타경비 정산은 SAP 가불정산화면을 이용하여 별도 처리 하시기 바랍니다.<br>
				※ 기타경비는 법인카드 또는 현금만 정산가능
				<div class="clear"></div>
				<br>
				<h3><span>체재비</span></h3>
				<table>
				...
				<table>
						...
						<tr>
							...
							<td class="inpt" style="width:90%" colspan="4">
								<textarea id="rem" style="width:95%; height:80px;border:0" readonly="readonly"></textarea>
							</td>
						</tr>
						<tr>
							<td class="tit" style="width:10%">협조내역</td>
							<td class="inpt" style="width:90%" readonly="readonly" colspan="4">
								<textarea id="assistComment" style="width:95%; height:80px;border:0" readonly="readonly"></textarea>
							</td>
						</tr>
						...
						<tr id="ghrTr" style="display:none">
							...
							<td class="inpt" style="width:90%" colspan="4">
								<textarea id="ghrComment" style="width:95%; height:300px" readonly="readonly"></textarea>
							</td>
						</tr>
				</table>
