...
//	public final static String DEFAULT_DERECTORY = FileUtil.UPLOAD_PATH + "/";
	...
	public static final String READ_CONFIG_PREFIX = "/dwe/framework/excel/read/";

	public static final String WRITE_CONFIG_PREFIX = "/dwe/framework/excel/write/";
//
//	/**
//	 * <pre>
...
//		return Configuration.getInstance().getInt(READ_CONFIG_PREFIX + "batch-size", defulat_batchSize);
//	}
//
//	/**
//	 * <pre>
...
//	 * @deprecated
//	 */
//	public final static String NEWEXCELFILEPATH = Configuration.getDweHome() + "/poi/newExcelFile.xls";
//
//	/**
//	 * @deprecated
//	 */
//	public final static String NEWCSVFILEPATH = Configuration.getDweHome() + "/poi/newCSVFile.csv";
