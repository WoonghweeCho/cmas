package com.dwenc.cmas.common.metaData.service.support;
...
public class JndiDataSource {
    ...
    private void initialize(String spec, Properties appProperties){
        jndiUsername = appProperties.getProperty("com.dwenc." + spec + ".database.user");
        jndiPassword = appProperties.getProperty("com.dwenc." + spec + ".database.password");
        jndiDriver = appProperties.getProperty("com.dwenc." + spec + ".database.driverClass");

        jndiName = appProperties.getProperty("com.dwenc." + spec + ".database.jndiName");
        contextFactory = appProperties.getProperty("com.dwenc." + spec + ".database.contextFactory");
        providerUrl = appProperties.getProperty("com.dwenc." + spec + ".database.providerUrl");
    }
