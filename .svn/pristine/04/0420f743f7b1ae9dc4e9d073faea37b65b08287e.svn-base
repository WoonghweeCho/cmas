...
//                    }
    ...
    private void injectQuery(String strStr, File aFile){
        try{
            ...
            if(strArry.length > 0) {
                ...
                if(aFile.getName().equals("COA0106Sqlmap.xml")) {
                    // logger.debug(0);
                }
                strStr = strArry[0];
                for(int i=1;i<strArry.length;i++) {
    ...
    public static void main(String[] args){
        ...
        conv.injectAll("C:/DoCFBaro-IDE/workspace/daewooenc.cmas/src/main/java");
//        conv.injectAll("C:/DoCFBaro-IDE/workspace/daewooenc.cmas/src/main/java/ll");
