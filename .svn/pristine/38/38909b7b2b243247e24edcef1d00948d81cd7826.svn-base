...
public class JdbcDataSource implements DataSource {
    ...
    private void initialize(String spec, Properties appProperties){
        try{
            jdbcDriver = appProperties.getProperty("com.dwenc." + spec + ".database.driverClass");
            jdbcUrl = appProperties.getProperty("com.dwenc." + spec + ".database.jdbcUrl");
            jdbcUsername = appProperties.getProperty("com.dwenc." + spec + ".database.user");
            jdbcPassword = appProperties.getProperty("com.dwenc." + spec + ".database.password");
