 ...
 *
 */
public class IdAppnDtl {
	private String appnUserId;
	...
	public String getAppnUserId() {
		return appnUserId;
	}
	public void setAppnUserId(String appnUserId) {
		this.appnUserId = appnUserId;
	}
	...
	public String getEmpmtNo() {
		return empmtNo;
	}
	public void setEmpmtNo(String empmtNo) {
		this.empmtNo = empmtNo;
	}
	...
	public String getCfYn() {
		return cfYn;
	}
	public void setCfYn(String cfYn) {
		this.cfYn = cfYn;
	}
